...
- [Atomic Test #12 - Execution via PowerShell using 'Start-Process' without argument](#atomic-test-12---execution-via-powershell-using-start-process-without-argument)

- [Atomic Test #13 - Execution via PowerShell using 'Start-Process' with argument](#atomic-test-13---execution-via-powershell-using-start-process-with-argument)

- [Atomic Test #14 - Execution via PowerShell using '&' without argument](#atomic-test-14---execution-via-powershell-using--without-argument)

- [Atomic Test #15 - Execution Via Bash with argument and library](#atomic-test-15---execution-via-bash-with-argument-and-library)
...
## Atomic Test #12 - Execution Via PowerShell Using 'Start-Process' without argument
Execution Via PowerShell Using 'Start-Process' without argument
...
## Atomic Test #13 - Execution Via PowerShell Using 'Start-Process' with argument
Execution Via PowerShell Using 'Start-Process' with argument
...
## Atomic Test #14 - Execution Via PowerShell Using '&' without argument
Execution Via PowerShell Using '&' without argument
...
## Atomic Test #15 - Execution Via Bash with argument and library
Execution Via Bash with argument and library
...
if [ -z "${LD_LIBRARY_PATH}" ]; then
        ...
        echo "LD_LIBRARY_PATH environment variable set to /tmp"
else
        if [[ "${LD_LIBRARY_PATH}" == *"/tmp"* ]]; then
                echo "LD_LIBRARY_PATH already includes the library path /tmp."
        else
...
##### Description: configure the runtime dependencies & libraries
##### Check Prereq Commands:
```sh
